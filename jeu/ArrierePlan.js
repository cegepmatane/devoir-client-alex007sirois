...
var ArrierePlan = function(scene)
{
	...
	{
		paysageEspace.graphics.beginBitmapFill(imageEspace,"repeat", matriceEspace).drawRect(0,0,scene.canvas.width,scene.canvas.height).endStroke();
		nombreImagesChargees++;
	}

	imageEtoiles.onload = function()
	{
		paysageEtoiles.graphics.beginBitmapFill(imageEtoiles,"repeat", matriceEtoiles).drawRect(0,0,scene.canvas.width,scene.canvas.height).endStroke();
	   	nombreImagesChargees++;
	}
	...
	this.changerVitesse = function(vitesse)
	{
